...
<article class="post type-post status-publish format-standard has-post-thumbnail hentry">	
	...
	<div class="post-wrapper group">
		...
		<div class="entry-footer group">
			...
			<?php if (!empty($next)): ?>
				<li class="next"><a href="<?php echo($next['url']); ?>" rel="next"><i class="fas fa-chevron-right"></i><strong>Next</strong> <span><?php echo($next['title']); ?></span></a></li>
			<?php endif;?>
			<?php if (!empty($prev)): ?>
				<li class="previous"><a href="<?php echo($prev['url']); ?>" rel="prev"><i class="fas fa-chevron-left"></i><strong>Previous</strong> <span><?php echo($prev['title']); ?></span></a></li>
			<?php endif;?>
			</ul>
